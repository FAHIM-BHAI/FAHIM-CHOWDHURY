...
registerFont(__dirname + `/cache/CaviarDreams.ttf`, {
    ...
    ctx.textAlign = "start";
    ctx.font = "55px time";
    ctx.fillText("FAHIM_CHOWDHURY", 930, 540)
    ctx.fillText("FAHIM_CHOWDHURY", 930, 610)
    ctx.fillText("FAHIM_CHOWDHURY", 930, 690)
    ctx.restore();
    ctx.save();
    ctx.beginPath();
